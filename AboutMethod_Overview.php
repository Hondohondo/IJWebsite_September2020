            ...
            <div class="col-3-of-3">
                <section class="section-house">
                  <div class="section-house-header">
                    <h5 class="heading-five">About the method | Overview</h5>
                    <h1 class="heading-one hr-overview">Overview</h1>
                  </div>
                ...
                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>Introduction to the <em>Intensive Journal</em> Program</h1>

                  <p>
                    Experience a life-changing process to give your life greater direction, vitality and purpose.
                    Developed in 1966 by Dr. Ira Progoff, our nationally-recognized program has helped 175,000 people lead more fulfilling lives.
                    Discover resources and possibilities you could not have imagined.
                    The <em><em>Intensive Journal</em> </em>method can be your honest friend in the creative process of shaping your life.
                  </p>

                  <h6>How can you benefit from this method?</h6>
                 ...
                 <li>
                  ...
                  <li>
                      Use a method that is without dogma. The <em>Intensive Journal</em> method is a process that can be used by people of all different backgrounds, interests and faiths.
                  </li>
                  <li>
