        ...
        <div class="expand">
            ...
            <div class="col-3-of-3">
                <section class="section-inside">
                  ...
                  <div class="banner">
                    <div class="banner-img" id="banner-img-118">&nbsp;</div>
                  </div>

                <div id="my-content" class="section-inside-content cms-editable">

                <h1>Dr Ira Progoff's Vision</h1>

                <div class="quotes">
                  <blockquote>
            "My goal in creating Dialogue House is to provide a place where people can go to work privately in their lives using the <em>Intensive Journal</em> method. Then, after the workshop, they can use the Journal on their own, returning as necessary to the workshops."
              </blockquote>
...
Kansas</p> -->
                ...
                <p>
              The <em>Intensive Journal</em> method is a process in which a person can place himself in the movement of his life to answer the question: where am I in my life? We use the <em>Intensive Journal</em> method to get our bearings, to break through periods of stalemate, and to work through issues, especially during periods of transition.
                </p>
