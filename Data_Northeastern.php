...
<table class="table-credits table-praises table-schedules">
   ...
   <!-- --><?php /*phpinfo(); */?>
    ...
    $sql = "SELECT State, City, URL, Module, DATE_FORMAT(Begins, '%M %d, %Y') AS Begins, DATE_FORMAT(Ends, '%M %d, %Y') AS Ends, Type, Sponsor, Telephone, Leader  from northeastern ORDER BY State, DATE_FORMAT(Begins, '%Y %m, %d')";
