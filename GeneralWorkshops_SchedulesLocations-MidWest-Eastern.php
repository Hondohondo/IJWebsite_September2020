...
<html lang="en">
    <head>
        ...
        <meta
            property="og:url"
            content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-MidWest-Eastern.php"
        />
    </head>
    <body>
            ...
            <div class="col-3-of-3">
                <div id="content" class="cms-editable">
                    <section class="section-inside">
                        ...
                        <div class="banner">
                            <div id="banner-img-16" class="banner-img"> </div>
                        </div>
                        <div id="my-content" class="section-inside-content">
                            <h1><em>Intensive Journal</em> Workshops - Eastern Region of Midwest</h1>
                            <!-- <br><br> -->
                            <h6>Winter-Spring, 2021</h6>
                            <p class="reg-flyer">
                                Please have a copy of our
                                <a class="page-link" href="midwest-east-3p-1219.pdf" target="_blank" rel="noopener"
                                    >Midwest-East regional flyer</a
                                >(Not Ready Yet)
                            </p>
                            <h5 id="chicago">
                                Detroit - Grand Rapids, Michigan:  Intro Workshop on May 15-16, 2021 Online
                            </h5>
                            <table class="table-credits table-praises" style="width: 77.705%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 48.7054%">
                                            5/15: (9 am-12:30 pm; 2-5 pm)<br />5/16: (9 am-12 pm; 1:30-4:30 pm)
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $100.  Full payment required at least two weeks in advance of workshop.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
