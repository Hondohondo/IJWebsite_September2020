...
<head>
    ...
    <meta property="og:url" content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-MidWest-Western.php">
</head>
<body>
            ...
            <div id="content" class="cms-editable">
                <section class="section-inside">
                    ...
                    <div id="my-content" class="section-inside-content">
                        ...
                        <!-- <br><br> -->
                        <p><sup>* </sup>Tuition only.  Workshop not held on July 26 and 29i.. Life Context workshop
                            includes <em>Intensive Journal</em> workbook.</p>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Location</th>
