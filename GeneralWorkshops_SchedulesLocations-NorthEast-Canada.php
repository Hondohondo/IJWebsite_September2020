...
<head>
    ...
    <meta property="og:url" content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-NorthEast-Canada.php">
</head>
<body>
            ...
            <div id="content" class="cms-editable">
                <section class="section-inside">
                    ...
                    <div id="my-content" class="section-inside-content">
                        ...
                        <p><sup>*  Tuition only.    Life Context workshop includes <em>Intensive Journal</em>
                                workbook.  Dialogue House reserves the right to adjust the tuition rate based upon
                                currency changes.   These rates are roughly the United States rates converted into
                                Canadian dollars. </sup><br>+ If your primary language is other than English, then you
                        ...
                        <p class="reg-flyer">Please have a copy of our <a class="page-link" href="israel-bc-0320.pdf"
                               target="_blank" rel="noopener">Victoria, BC regional brochure </a></p>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Workshop (12 hrs)</th>
                                ...
                                <tr>
                                    <td>Depth Contact</td>
                                    <td>10/19: (6-9 pm)<br>10/26: (6-9 pm)<br>11/02: (6-9 pm)<br>11/09: (6-9 pm)</td>
                                    <td>                                             $ 250 CN</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Location</th>
                                    <td><strong>The Church of Truth</strong> is located in the James Bay residential
                                        neighborhood of Victoria, BC at 111 Superior Street. Restaurants and lodging
                                        are nearby. Contact Bill for lodging information.</td>
                                </tr>
                                <tr>
                                    <th>Leader</th>
                                    <td><strong>Bill Israel</strong> is a long-time practitioner of the <em>Intensive
                                            Journal</em> method, with 40 years of experience in effecting his own life
                                        transitions. Bill worked as an ordained pastor, a group and family therapist,
                                        and then as a professional human resource trainer and consultant. He now
                                        conducts a private counseling and consulting practice in Victoria, B.C.,
                                        working as a Life Transition Facilitator.</td>
                                </tr>
                                <tr>
                                    <th>Registration</th>
                                    <td>Call <strong>250-744-0590 </strong> or email billisrael06@gmail.com write to:
                                        Centre for Earth &amp; Spirit Society, 350 King George Terrace, Victoria, BC
                                        V8S 2K2 Canada. <a class="page-link" href="www.centreforearthandspirit.ca">www.centreforearthandspirit.ca</a>
                                        Make cheque payable to Centre for Earth and Spirit Society. Minimum
                                        nonrefundable deposit: $50. Payment by credit card (Visa/MC/AMEX/Discover) on
                                        <a class="page-link" href="www.centreforearthandspirit.ca">www.centreforearthandspirit.ca</a>
                                        info@centreforearthandspirit.ca</td>
                                </tr>
                            </tbody>
                        </table>
                        <h5> </h5>
                        <h5> </h5>
                        <h5> Winnipeg, Manitoba:  Dates TBA for 2021-2022</h5>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Workshop (12 hrs)</th>
                        ...
                        <!-- <br><br> -->
                        <p><sup>#</sup>Includes tuition and lunch. * Includes tuition, double room and meals. Single
                            rooms are available for an extra $10. + Includes tuition, double room and meals. Single
                            rooms are available for an extra $20. <br><br>Residents taking both workshops on
                            2/14-2/17/20: add $50 for extra overnights and meals</p>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Location</th>
                                    <td>The workshop will be held at <strong>St. Benedict&apos;s Retreat &amp;
                                            Conference Centre</strong>, a leading retreat center in Winnipeg, Manitoba.
                                        The centre is located on 19 acres of scenic wooded land bordering the Red
                                        River, an ideal quiet setting for your journal workshop experience.</td>
                                </tr>
                                <tr>
                                    <th>Leader</th>
                                    <td><strong>Virginia Evard, OSB,</strong> has twenty years experience in spiritual
                                        direction and retreat work and is the prioress of St. Benedict&apos;s
                                        Monastery. She holds a Master of Arts degree as well as a Masters of Pastoral
                                        Studies and has had extensive experience in conducting <em>Intensive Journal</em>
                                        workshops.</td>
                                </tr>
                                <tr>
                                    <th>Registration</th>
                                    <td>Call <strong>204-339-1705</strong> or write to: St. Benedict&apos;s Retreat
                        ...
                        <!-- <br><br> -->
                        <p><sup>#</sup>Tuition and meals (Monday dinner and Tuesday lunch). <br><sup>*</sup>Tuition,
                            one overnight (single bedroom), and meals (Monday dinner and Tuesday breakfast and lunch).
                            <br>All meals are vegetarian. Bedrooms not reserved by August 15 will be released back to
                            the centre and are available on a first-come basis.</p>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Location</th>
                                    <td><strong> The Salt Spring Centre of Yoga</strong> is located on Salt Spring
                                        Island, BC, only a 30 minute ferry ride from Victoria. This well-established
                                        centre offers yoga and other related workshops at its modern facility on its 69
                                        acres of meadows, forest, and a large organic farm that supplies most of the
                                        produce for its vegetarian meals. see www.saltspringcentre.com</td>
                                </tr>
                                <tr>
                                    <th>Leader</th>
                                    <td><strong>Bill Israel</strong> is a long-time practitioner of the <em>Intensive
                                ...
                                <tr>
                                    <th>Registration</th>
                                    <td>Call <strong> 250-744-0590 </strong> or email billisrael06@gmail.com write to:
                                        Centre for Earth &amp; Spirit Society, 1924 Sandover Crescent, North Saanich,
                                        BC V8L 1A1 Canada. www.centreforearthandspirit.ca Make cheque payable to Centre
                                        for Earth and Spirit Society. Minimum nonrefundable deposit: $125. Payment by
                                        credit card (Visa/MC/AMEX/Discover) on www.centreforearthandspirit.ca
                                        info@centreforearthandspirit.ca</td>
                                </tr>
                            </tbody>
                        </table>
