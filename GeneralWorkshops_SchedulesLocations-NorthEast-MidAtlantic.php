...
<html lang="en">
    <head>
        ...
        <meta
            property="og:url"
            content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-NorthEast-MidAtlantic.php"
        />
    </head>
    <body>
                    ...
                    <section class="section-inside">
                        <div class="section-inside-header">
                            ...
                            <div class="inside-nav-container">
                                ...
                                <ul class="inside-nav">
                                    ...
                                    <li>
                                        <a href="GeneralWorkshops_SchedulesLocations-NorthEast.php"
                                            >← Northeastern Region</a
                                        >
                                    </li>
                                    <!-- <span class="vert">&vert;</span> -->
                                </ul>
                        ...
                        <div id="my-content" class="section-inside-content">
                            ...
                            <p class="reg-flyer">
                                ...
                                <a class="page-link" href="midatlantic-3p-1219.pdf" target="_blank" rel="noopener"
                            ...
                            <!-- <br><br> -->
                            <p>
                                * Tuition only.  Workshops not held on September 20 and 23.  Life Context workshop
                            ...
                            <table class="table-credits table-praises" style="width: 100%; height: 643px">
                                <tbody>
                                    ...
                                    <tr style="height: 253px">
                                        ...
                                        <td style="width: 82.3785%; height: 253px">
                                            Call <strong>330-998-6000 or 800-221-5844 </strong>or write to
                                            <strong>Dialogue House</strong>, 2245 E Enterprise Pkwy - #B1, Twinsburg,
                                            OH  44087-2348.  Email: info@intensivejournal.org Credit cards accepted.
                                            Make checks payable to Dialogue House.   Minimum non-refundable deposit: 
