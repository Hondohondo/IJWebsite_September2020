...
<head>
    ...
    <meta property="og:url" content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-NorthEast-NewEngland.php">
</head>
<body>
        ...
        <div class="col-3-of-3">
            <div id="content" class="cms-editable">
                <section class="section-inside">
                    ...
                    <div class="banner">
                        <div id="banner-img-20" class="banner-img"> </div>
                    </div>
                    <div id="my-content" class="section-inside-content">
                        <h1><em>Intensive Journal</em> Workshops - New England Region</h1>
                        <!-- <br><br> -->
                        <h6>Summer, 2021</h6>
                        <p class="reg-flyer">Please have a copy of our <a class="page-link" href="new-england-3p-1219.pdf"
                               target="_blank" rel="noopener">New England regional flyer</a>(Not Ready Yet)</p>
                        <h5 id="boston">Boston, MA:   3-Part Series on May 15-22, 2021 - online</h5>
                        <table class="table-credits table-praises">
                            <tbody>
                                ...
                                <tr>
                                    <td>Life Context</td>
                                    <td>05/15:  (9 am-12:30 pm; 2-5 pm)<br>05/16:  (9 am-12 pm; 1:30-4:30 pm)</td>
                                    <td>$ 225</td>
                                </tr>
                                <tr>
                                    <td>Depth Contact</td>
                                    <td>05/18:  (9 am-12:30 pm; 2-5 pm)<br>05/19:  (9 am-12 pm; 1:30-4:30 pm)</td>
                                    <td>$ 210</td>
                                </tr>
                                <tr>
                                    <td>Life Integration</td>
                                    <td>05/21:  (9 am-12:30 pm; 2-5 pm)<br>05/22:  (9 am-12 pm; 1:30-4:30 pm)</td>
                                    <td>$ 210</td>
                                </tr>
                                <tr>
                        ...
                        <p>* Tuition only.  <em>Intensive Journal</em> workbook included in Life Context module.</p>
                        <table class="table-credits table-praises">
                            <tbody>
                                <tr>
                                    <th>Location</th>
