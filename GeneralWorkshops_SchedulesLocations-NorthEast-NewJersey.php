...
<head>
    ...
    <meta property="og:url" content="https://www.intensivejournal.org/GeneralWorkshops_SchedulesLocations-NorthEast-NewJersey.php">
</head>
<body>
            ...
            <div id="content" class="cms-editable">
                <section class="section-inside">
                    ...
                    <div id="my-content" class="section-inside-content">
                        ...
                        <!-- <br><br> -->
                        <h6>Fall, 2020 - Winter, 2021</h6>
                        <p class="reg-flyer">Please have a copy of our <a class="page-link" href="nyc-3p-1219.pdf"
                               target="_blank" rel="noopener">New York City regional flyer  (not ready yet)</a></p>
                        <h5 id="manhattan">New York City (Manhattan): 3-Part Series Begins October 17-18, 2020 - online<br>                                                                   
                            Date Change</h5>
                        <table class="table-credits table-praises">
                            <tbody>
                                ...
                                <tr>
                                    <td>Life Context</td>
                                    <td>10/17: (9 am-12:30 pm; 2-5 pm)<br>10/18: (9 am-12 pm; 1:30-4:30 pm)</td>
                                    <td>$ 225</td>
                                </tr>
                                <tr>
                                    <td>Depth Contact</td>
