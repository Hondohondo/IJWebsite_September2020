            ...
            <div class="col-3-of-3">
                <section class="section-house">
                  <div class="section-house-header">
                    <h5 class="heading-five">Miscellaneous | Contact us</h5>
                    <h1 class="heading-one hr-overview">Contact Us</h1>
                  </div>
                  <div class="banner">
                ...
                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>Please use the form below to reach us </h1>

                  <div class="login-form">
                      <h2 class="heading-secondary ma-bt-lg">Contact us</h2>

                      <form action="https://getform.io/f/fa05c72f-1227-44e1-ab50-f6dcdf16bd27" class="form form--signup" method="POST">
                          ...
                          <div class="form__group">
                              ...
                              <input class="form__input" id="subject" type="text" name="subject" placeholder="subject" required>
                          </div>

                           <div class="form__group">
                              <label class="form__label" for="message">Message</label>
                               <textarea class="form__input" id="message" type="tel" name="message" placeholder="Your message" required></textarea>
