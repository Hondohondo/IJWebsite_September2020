        ...
        <div class="expand">
            ...
            <div class="col-3-of-3">
                ...
                <div id="my-content" class="section-inside-content cms-editable">
                  ...
                  <p>
                    The <em>Intensive Journal</em> method provides specific techniques through our integrated system of writing exercises to help your clientele in many ways:
                  </p>
                ...
                <ul>
                  <li>Explore traumatic events in a safe, supportive environment protected by total privacy, and nurtured by a group that provides an energy and momentum to move through issues.</li>
                  <li>
            ...
            Work Through Feelings of Pain and Guilt
                ...
                <ul>
                  <li>Access feelings and experiences to become more aware of behavior and attitudes.  Become more expressive and grounded.</li>
                  <li>
          ...
          Uncover Interests, Talents and Possible Projects
                ...
                <ul>
                  <li>Explore prior periods of your life to unearth interests and talents that may be  ripe for development.</li>
                  <li>
          ...
          Gain Momentum and Renewed Energy
                ...
                <ul>
                  <li>Avoid preconceived ways of thinking that create a stalemate by using the Journal Feedback process, a core feature of the method, see <a href="AboutMethod_JournalFeedback.php" class="page-link">Journal Feedback process</a></li>
                  <li>
          ...
          Use an Integrated Holistic Approach
                ...
                <ul>
                  <li>View specific issues within the context of one's entire life using Progoff's whole-life process (see <a href="AboutMethod_WholeLife.php" class="page-link">Whole-Life Process</a>);  realize connections between areas of life using the Journal Feedback technique.</li>
                  <li>
