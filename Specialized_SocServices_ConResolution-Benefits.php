        ...
        <div class="expand">
            ...
            <div class="col-3-of-3">
                ...
                <div id="my-content" class="section-inside-content cms-editable">
                  ...
                  <p>
              The <em>Intensive Journal</em> method provides specific techniques through our integrated system of writing exercises to help participants:
                  </p>
                  ...
                  <ul>
                    <li>
                      Release intense feelings of anger and hatred in the <em>Intensive Journal</em> workbook, not in a violent way.  One particpant stated: <em>" I killed him in my Journal with my ballpoint pen..."</em> see footnote 7.
                    </li>
                  </ul>

                  <h6 class="u-margin-top-small-1">
                  ...
                  <ul>
                    ...
                    <li>
                      Change behavior and attitudes toward others after the workshop, resulting in greater harmony and meaningful coexistence. <a href="Specialized_SocServices_ConResolution-Endorse.php">See statements by Harvey  Shrum, EdD and Marcella  Hardt</a>
                    </li>
                  </ul>
