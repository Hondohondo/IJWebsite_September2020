...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="https://www.intensivejournal.org/WesternTable.php" />
  </head>
  <body>
      ...
      <table id="test-table" class="table-credits table-praises table-schedules table" style="width: 59.4582%">
        ...
        <tbody>
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthWest.php#mesa"
                >Phoenix-Tucson</a
              >
            </td>
          ...
          <tr>
            <td style="width: 10.7354%">Arizona</td>
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthWest.php#carefree"
                >Phoenix-Tucson</a
              >
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-NorthCA.php#sanfran"
          ...
          <tr>
            <td style="width: 10.7354%">California - North</td>
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-NorthCA.php#sacramento"
                >San Francisco-Sacramento</a
              >
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthCA.php#fresno">Fresno</a>
            </td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthCA.php#sandiego"
                >Los Angeles - San Diego</a
              >
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
            <td class="day" style="width: 10.7275%">May 1, 2021<span id="dayofweek">Saturday</span></td>
            <td class="day" style="width: 10.7434%">May 2, 2021<span id="dayofweek">Sunday</span></td>
            <td style="width: 10.8323%">Weekend / Solo</td>
            <td style="width: 10.8722%">Dialogue House</td>
            <td style="width: 12.5448%">330-998-6000 / <br />800-221-5844</td>
            <td style="width: 11.0115%">Joanne Hackett Ching</td>
          </tr>
          <tr>
            <td style="width: 10.7354%">California - South</td>
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthCA.php#la"
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthWest.php#denver">Denver</a>
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-SouthCA.php#honolulu">Honolulu</a>
            </td>
            <td style="width: 8.47471%">LC-10</td>
            <td class="day" style="width: 10.7275%">TBA<span id="dayofweek">TBA</span></td>
            <td class="day" style="width: 10.7434%">TBA<span id="dayofweek">TBA</span></td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-NorthWest.php#salem">Portland</a>
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">LC-ONL</td>
            <td class="day" style="width: 10.7275%">March 17, 2021<span id="dayofweek">Wednesday</span></td>
            <td class="day" style="width: 10.7434%">March 18, 2021<span id="dayofweek">Thursday</span></td>
            <td style="width: 10.8323%">Weekday / Weekly</td>
            <td style="width: 10.8722%">Evelyn Wemhoff</td>
            <td style="width: 12.5448%">971-273-0700</td>
            <td style="width: 11.0115%">Evelyn Wemhoff</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">DC-ONL</td>
            <td class="day" style="width: 10.7275%">March 24, 2021<span id="dayofweek">Friday</span></td>
            <td class="day" style="width: 10.7434%">
              <p>March 25, 2021</p>
              <p><span id="dayofweek">Friday</span></p>
            </td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">LI-ONL</td>
            <td class="day" style="width: 10.7275%">March 31, 2021<span id="dayofweek">Wednesday</span></td>
            <td class="day" style="width: 10.7434%">April 1, 2021<span id="dayofweek">Thursday</span></td>
            <td style="width: 10.8323%">Weekend / Weekly</td>
            <td style="width: 10.8722%">Evelyn Wemhoff</td>
            <td style="width: 12.5448%">971-273-0700</td>
            <td style="width: 11.0115%">Evelyn Wemhoff</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">LC-ONL</td>
            <td class="day" style="width: 10.7275%">May 5, 2021<span id="dayofweek">Wednesday</span></td>
            <td class="day" style="width: 10.7434%">May 6, 2021<span id="dayofweek">Thursday</span></td>
            <td style="width: 10.8323%">Weekday / Weekly</td>
            <td style="width: 10.8722%">Evelyn Wemhoff</td>
            <td style="width: 12.5448%">971-273-0700</td>
            <td style="width: 11.0115%">Evelyn Wemhoff</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">DC-ONL</td>
            <td class="day" style="width: 10.7275%">May 12, 2021<span id="dayofweek">Wednesday</span></td>
            <td class="day" style="width: 10.7434%">
              <p>May 13, 2021</p>
              <p><span id="dayofweek">Thursday</span></p>
            </td>
            <td style="width: 10.8323%">Weekend / Weekly</td>
            <td style="width: 10.8722%">Evelyn Wemhoff</td>
            <td style="width: 12.5448%">971-273-0700</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">LI-ONL</td>
            <td class="day" style="width: 10.7275%">May 19, 2021<span id="dayofweek">Wednesday</span></td>
            <td class="day" style="width: 10.7434%">May 20, 2021<span id="dayofweek">Thursday</span></td>
            <td style="width: 10.8323%">Weekend / Weekly</td>
            <td style="width: 10.8722%">Evelyn Wemhoff</td>
            <td style="width: 12.5448%">971-273-0700</td>
            <td style="width: 11.0115%">Evelyn Wemhoff</td>
          ...
          <tr>
            ...
            <td style="width: 13.5086%">
              <a class="page-link" href="GeneralWorkshops_SchedulesLocations-Western-NorthWest.php#seattle">Seattle</a>
            </td>
            <td style="width: 8.47471%">LC-ONL</td>
            <td class="day" style="width: 10.7275%">March 6, 2021 <span id="dayofweek">Saturday</span></td>
            <td class="day" style="width: 10.7434%">March 7, 2021<span id="dayofweek">Sunday</span></td>
            <td style="width: 10.8323%">Weekend / Weekly</td>
            <td style="width: 10.8722%">Dialogue House</td>
            <td style="width: 12.5448%">330-998-6000 / 800-221-5844</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">DC-ONL</td>
            <td class="day" style="width: 10.7275%">March 27, 2021<span id="dayofweek">Saturday</span></td>
            <td class="day" style="width: 10.7434%">March 28, 2021<span id="dayofweek">Sunday</span></td>
            <td style="width: 10.8323%">Weekday / Weekly</td>
            <td style="width: 10.8722%">Dialogue House</td>
            <td style="width: 12.5448%">330-998-6000 / 800-221-5844</td>
            <td style="width: 11.0115%">Carol Ladas- Gaskin</td>
          ...
          <tr>
            ...
            <td style="width: 8.47471%">LI-ONL</td>
            <td class="day" style="width: 10.7275%">April 17, 2021<span id="dayofweek">Saturday</span></td>
            <td class="day" style="width: 10.7434%">April 18, 2021<span id="dayofweek">Sunday</span></td>
            <td style="width: 10.8323%">Weekday / Weekly</td>
            <td style="width: 10.8722%">Dialogue House</td>
            <td style="width: 12.5448%">330-998-6000 / 800-221-5844</td>
            <td style="width: 11.0115%">Carol Ladas- Gaskin</td>
