...
<?php include "../headhtml2.php";?>
    <body>
                ...
                <section class="section-inside">
                  <div class="section-inside-header sticky">
                    ...
                    <div class="inside-nav-container">
                      <hr class="work-hr">
                    <ul class="inside-nav">
                      <li><a href="../Specialized_Profession_Ministry-Articles.php">&larr; Ministry</a></li>
                  ...
                  <div class="banner">
                    <div class="banner-img" id="banner-img-11">&nbsp;</div>
                  </div>

                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>The <em>Intensive Journal</em>® Method: a Tool for Ministry*</h1>
                <em>
                  <p>by The Rev. James D. Miller, D. Min.**</p>
                </em>
                <em>
                  <p>The Rev. Dr. James D. Miller of Trinity United Church of Christ in Mt. Penn, Reading, PA explains how the <em>Intensive Journal</em> method has been a valuable tool for his personal and professional life, and for his work in ministry. He describes the theoretical basis for the <em>Intensive Journal</em> process and the deeper spiritual implications it has for Christianity.  </p>
                </em>
          ...
          Pastors, like everyone else, struggle with questions of identity and meaning not only with those whom they serve in the church but within themselves. How can they be expected to help others if they have found no way to bring integration and wholeness into the many claims and demands and questions of their own lives?
            ...
            The <em>Intensive Journal</em> method was designed by Ira Progoff, Ph. D. as a means to implement his views of holistic depth psychology. Progoff traced a movement beginning with Freud as the founding father of psychoanalysis and showed how psychology, fighting for recognition as a science, as a means of methodically understanding the human psyche and dealing with its symptoms and illnesses, came to something of a dead end. It could not answer all the questions and even Freud was forced to admit that psychological theory led beyond itself to what some describe as the realm of meaning and spirit.
              ...
              It is in this very central quest, that search for meaning which can bring wholeness and integration to a person as it is experienced personally, that Progoff felt humanistic or holistic depth psychology could be of greatest service to our life. What pathological schools of psychotherapy interpreted as illness and problems within the psyche, Progoff viewed as evidences that the process of unfolding of the psyche has become stuck or blocked. He would proceed to work with the person in this blocked condition by neither trying to analyze the difficulty nor attempting to understand it, but rather helping the person connect once more to the inner movement of his or her life.
                ...
                <p>
            The psyche makes itself visible and vocal, directing the life process by symbolic images, words, and concepts. Progoff, in line with Jung, sees the psyche as the dwelling place of what he calls the "protoplasmic image", that is, the image of what the person is meant to be. It is this guiding image within which directs and channels the life energies. Depth psychology then tries to build bridges as it were to provide means for this inner knowing to come forth and connect itself to the outer life of the person. The <em>Intensive Journal</em> procedures are designed to draw these symbols forth without imposing any predetermined meaning or direction upon them.
                </p>

                <h6>Theological Aspects of the <em>Intensive Journal</em> Process </h6>

                <p>
              Progoff professes to offer in the <em>Intensive Journal</em> process a system which has no content of its own, but rather uses the particular content of the individual life in all of its many phases and forms, including the spiritual aspect. Examining some of the dimensions of depth psychology in the light of Christian tradition provides a necessary opportunity to reflect upon the deeper implications of the <em>Intensive Journal</em> method for the Christian pastor.
                </p>
        ...
        Both Biblical religion and depth psychology agree on the seriousness of the human condition. Where depth psychology has discovered methods to enable persons to develop inner resources that have lain dormant to new growth, Biblical religion can offer the spiritual experience of those who have encountered the living God over the centuries to interpret and discern how God is calling forth God's people into new directions and possibilities. The church, as the biblical community in our day, offers therefore a corrective context which depth psychology needs, and depth psychology offers the church an opportunity, through grasping more fully the nature of personal religious experience, to open up to new winds of the Spirit which are calling us to new seriousness to face the challenges of ministering to the modern person.
                ...
                <p>
If we can use depth psychology to help keep ourselves in touch with the whole of our life, knowing that God is involved with us at each step, using our Christian traditions and doctrines along with the Scriptures as an interpreter for our experience, then depth psychology in general and the <em>Intensive Journal</em> method in particular can serve us well.
                </p>

                <h6>
                  The <em>Intensive Journal</em> Workbook
                </h6>

                <p>
            The <em>Intensive Journal</em> workbook is a simple three ring notebook. Log sections are used to record the raw material of our lives. They are to be neutral observations, a simple, brief recording of our inner and outer experiences. These entries provide the base material with which we work in the other sections of the <em>Intensive Journal</em> workbook using what Progoff calls the Feedback Exercises.
                </p>

                <p>
                  The Feedback Exercises digest the raw material provided by the Log sections and transform it through various mini-processes, generating new experience and carrying forward the inner movement of life to the next steps. A series of <em>Intensive Journal</em> Workshops have been developed to take the novice and the veteran participant through the process step by step, explaining and helping each one to move at his or her own pace.
                </p>
...
<h6>
  A Tool for the Ministry
                ...
                <p>
Just as the <em>Intensive Journal</em> method can make a significant contribution to the lives of pastors, so it can also make a significant contribution to the lives of those they serve in their congregations. Some counseling will be done each week if not each day in the church, and the pastor is expected to work with all kinds of people with all different degrees of need. A chief area of concern in counseling for me was that persons oftentimes tended to become dependent on the counselor. I began to feel that some method was required which those coming for help could learn to use on their own, coming back only as necessary for occasional guidance. A series of exercises were prepared for use with those I would counsel and, for those who follow through, the <em>Intensive Journal</em> method has been a helpful way for persons to focus their life and work through particular problems.
                </p>

                <p>
                  The worship service of the local church remains at the center of the life of every congregation. The <em>Intensive Journal</em> method, by keeping the pastor more in touch with the movement of his or her own life, can contribute to new depth in worship as services and sermons flow from a deeper personal level within the pastor. On occasion, I have had very powerful insights to Scripture and church doctrine through the <em>Intensive Journal</em> method. There is an inner awareness that has come in a new and exciting way and in a form which can easily be communicated to others. By reading the dialogue script I wrote, I found others quickly become involved and interested more so than with a simple description of the experience. My own experience is that when one is firmly rooted in Biblical faith and in active relationship to God and the church, there will be much that will come forth from working in the <em>Intensive Journal</em> method which can be fed back into the life of the church in many ways.
                </p>
                ...
                <p>
                  <em>* Based upon Doctor of Ministry Thesis by The Rev. Dr. James D. Miller entitled "The <em>Intensive Journal</em>: A Tool for Ministry," Lancaster Theological Seminary, 1979. © Copyright 2003. James Miller. Reprinted with permission of the author.  </em>
                </p>
                <p>
                  <em>** James Miller is Senior Pastor at Trinity United Church of Christ in Mt. Penn, Reading, Pennsylvania. He has been a certified leader of the <em>Intensive Journal</em> program under the auspices of Dialogue House since 1976. </em>
                </p>
                <p>
                  <em>"<em>Intensive Journal</em>" and "Journal Feedback" are trademarks of Jon Progoff and used under license by Dialogue House.</em>
                </p>
