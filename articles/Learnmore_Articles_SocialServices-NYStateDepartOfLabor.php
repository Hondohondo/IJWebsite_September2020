    ...
    <body>
                ...
                <section class="section-inside">
                  <div class="section-inside-header sticky">
                    ...
                    <ul class="inside-nav">
                      ...
                      <span class="vert">&vert;</span>
                      <li><a href="../Specialized_SocServices_ConResolution-Articles.php">&larr; Conflict Resolution</a></li>
                      <span class="vert">&vert;</span>
                  ...
                  <div class="banner">
                    <div class="banner-img" id="banner-img-27">&nbsp;</div>
                  </div>

                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>The New York State Department of Labor Job-Training Program: Applying the Progoff <em>Intensive Journal</em> Method </h1>
                <em>
                  <p>by Shirley Sealy and Tom Duffy </p>
                </em>
                <em>
                  <p>After Dr. Ira Progoff developed the <em>Intensive Journal</em> method, he began to expand its applications to include participants with various backgrounds and experiences. His research into how the Method would work with those of limited education included the Job Training Program that is described below.  </p>
                </em>
                <em>
                  <p>As we look for new applications of the <em>Intensive Journal</em> method, Dr. Progoff's pioneering research shows the Method's effectiveness and relevance for helping people in today's society.  </p>
                </em>
        ...
        The program was structured with three main elements: 1) extensive on-the-job training lasting from 20 to 33 weeks, depending on job classification, 2) remedial education such as basic reading and writing, English as a second language, high school equivalency courses, etc., and 3) the Dialogue House group workshops based on the <em>Intensive Journal</em> method.
          ...
          A new group of trainees was cycled in each month, and after five months of training, the group graduated and assumed full time employment as nurses' aides, dietary workers, security officers, maintenance men, housekeepers, activities workers, etc., at the new residence building.
                ...
                <p>
                  Each class of trainees attended a large weekly workshop conducted by Dr. Progoff as well as once-a-week, smaller group sessions led by Dialogue House staff leaders.
Individual sessions could be arranged by appointment, and each trainee had at least three private sessions with a staff leader during the training period. The staff leaders had been trained by Dr. Progoff, and worked under his supervision.
                </p>

                <p>
                  Some observations of Dr. Progoff may help to convey the underlying sense of the project, and of the <em>Intensive Journal</em> method in general. Dr. Progoff believes that:
                </p>

                <p>
                  <ul>
                    <li>The ultimate poverty is a person’s lack of feeling for the reality of his own inner being. People in poverty situations tend to feel they are powerless to change their circumstances because their individuality is submerged by the group situation. Thus, they do not feel they are persons and therefore that they have no power to redirect their lives.</li>

                    <li>
                      The answer to poverty lies in making it tangibly possible for a person to experience the fact that he is a person. We do that in our program by using the <em>Intensive Journal</em> method in such a way that it becomes the outer embodiment of the inner life of the individual...
                    </li>
                    ...
                    <li>
                      When this principle is awakened through the use of the <em>Intensive Journal</em> method, the trainees become aware of their capacities, and realize that they are indeed persons and that they need live in poverty no longer.
                    </li>
                  </ul>
                </p>
...
An initial statistical check completed at the end of the program revealed that, of the 286 people who had entered the training program, 12 were asked to leave because of drug use, alcoholism or physical inability; 6 quit because of illness or pregnancy; 19 simply dropped out; 249 completed the program and were employed at Isabella. The drop-out rate was an amazing 7%.
            ...
            A follow-up check one year later showed that of the 249 who completed the program, 151 were still working at their original level and 11 had been upgraded to senior status or supervisor. The 87 no longer employed break down this way:
                ...
                <p>
                  <ul>
                    <li>31 have taken other jobs where their work schedule allowed them to go to school. </li>
                    <li>29 have taken better paying jobs. </li>
                    <li>
                ...
                <p>
                  <ul>
                    <li>37% had moved to better housing. </li>
                    <li>21% were continuing their education at night school or community colleges.</li>
                    <li>
