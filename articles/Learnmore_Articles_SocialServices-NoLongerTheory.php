        ...
        <div class="expand">
            ...
            <div class="col-3-of-3">
                <section class="section-inside">
                  <div class="section-inside-header sticky">
                    ...
                    <div class="inside-nav-container">
                      <hr class="work-hr">
                    <ul class="inside-nav">
                      <li><a href="../Specialized_SocServices_JobTraining-Articles.php">&larr; Job Training</a></li>
                      <span class="vert">&vert;</span>
                      <li><a href="../Specialized_SocServices_CrimJustice-Articles.php">&larr; Criminal Justice</a></li>
                      <span class="vert">&vert;</span>
                ...
                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>No Longer Theory: Correctional Practices That Work</h1>
                <em>
                  <p>by Harvey Shrum Ed. D.</p>
                </em>
            ...
            * Rehabilitation does have an impact in reducing recidivism.
            ...
            <h6>
              References
                ...
                <p>
              Batiuk, Mary Ellen (June 1997). "The State of Post-secondary Education in Ohio/ Journal of Correctional Education, 48 (2), 70-72.
                </p>

                <p>
                Batiuk, M. E., P. Moke, and P. W. Rounree (March 1997). "Crime and Rehabilitation: Correctional Education as an Agent of Change: A Research Note/ Justice Quarterly, 14, (1).
                </p>

                <p>
                Caulkins, J. P., C. P. Rydell, W. Schwabe, and J. Chiesa (1997). Mandatory Minimum Drug Sentences: Throwing Away the Key or the Taxpayer's Money? RAN D Corporation Study.
                </p>

                <p>
                  Condelli, W. S. & R. L Hubbard (1994). "Relationship between Time Spent in Treatment and Client Outcomes from Therapeutic Communities/ Journal of Substance Abuse Treatment, 77(1), 25-33.
                </p>

                <p>
                  Crumbaugh, James C. (May 1972). "Changes in Frankl's Existential Vacuum as a Measure of Therapeutic Outcome/ Newsletter for Research in Psychology, H (2).
                </p>

              <p>
                Cypser, R. J. (October 1997). What Works in Reducing Recidivism and Thereby Reducing Crime and Cost. New York: CURE.
              </p>
                <p>
                  Dryden, Windy (2002). Handbook of Individual Therapy. Sage Publications, Fourth Edition.
                </p>

                <p>
                  Edelstein, M. R. and D. R. Steele (1997). Three-Minute Therapy: Change Your Thinking, Change Your Life. Clendbridge Publishing Company.
                </p>

            <p>
              Fabry, Joseph B. (1988). Guideposts to Meaning: Discovering What Really Matters. Oakland, California: New Harbinger Publications, Inc.
            </p>

              <p>
                Fabry, Joseph B. (1994). Pursuit of Meaning. Abilene, Texas: Institute of Logotherapy Press.
              </p>

              <p>
                Fabry, Joseph B. (1995). Finding meaning in Life: Logotherapy. New York: Jason Aronson.
              </p>

              <p>
                Ferrell, Vance (2003). Hard Drugs Can Ruin You. Altamont, Texas: Harvestime Books.
              </p>
              ...
              <p>
                Gearan, Anne (April 9, 2003). Kennedy: Too Many People Are Behind Bars. The Associated Press.
              </p>

              <p>
                Harer, Miles (1994). Recidivism Among Federal Prisoners Released in 7987. Federal Bureau of Prisons Office of Research & Evaluation.
              </p>

              <p>
                Lifton, Robert Jay (1969). History and Human Survival. New York: Random House.
              </p>


              <p>
                Lipton, Douglas S. (November 1995). The Effectiveness of Treatment for Drug Abusers Under Criminal Justice Supervision. National Institute of Justice Research Report.
              </p>

              <p>
                Manitonquat (1996). Ending Violent Crime: A Vision of a Society Free of Violence. Publisher.
              </p>

              <p>
                Mauer, Marc and Tracy Ruling (October 1995). Young Black Americans and the Criminal Justice System: Five Years Later. The Sentencing Project.
              </p>

              <p>
                McMahon, Patrick (August 10, 2003). "States Revisit "Get-Tough" Policies as Revenue Slows, Prisons Overflow.' USA Today.
              </p>

              <p>
                Ross, J. M. (1987). "Learning Disabled Adults: Who Are They and What Do We Do With Them?' Lifelong Learning 77, No. 3: 4-7, 11. (ERIC #EJ 361 993).
              </p>

              <p>
                Rydell, Peter and Susan S. Everingham (1994). Controlling Cocaine: Supply vs. Demand Programs. A joint study by the RAND Corporation, the U. S. Army, and the Office of National Drug Control Strategy.
              </p>

              <p>
          Sealy, S. A. and T. F. Duffy (1977). The New York State Department of Labor Job-Training Program: Applying the Progoff <em>Intensive Journal</em> Method. Abridged Report.
              </p>

              <p>
                Sullivan, J. (1995). From Classrooms to Cellblocks: A National Perspective. Center on Juvenile and Criminal Justice.
              </p>

              <p>
                Taylor, Jon M. (September 1992). "Post secondary Correctional Education: An Evaluation of Effectiveness and Efficiency/ Journal of Correctional Education, 43 (3), 132-141.
              </p>

              <p>
                Waldon Jr., Alton R. (April 1996). Unhealthy choice: Prisons Over Schools in New York State. State Senator, 10th District.
              </p>

              <p>
                _____ (March 1993). Survey of State Prison Inmates, 7997. Bureau of Justice Statistics, NCJ136949.
              </p>

              <p>
                _____ (1996). The Eighth Annual Shock Legislative Report 1996. New York Department of Correctional Services and the Division of Parole.
              </p>

              <p>
                _____ (1994). The Impact of Correctional Education on Recidivism, 7988- 7994. Office of Correctional Education, U.S. Department of Education.
              </p>

              <p>
                _____ (1996). Brooklyn Treatment Alternatives to Street Crime (TASQ, 7997-7992.
              </p>

              <p>
                _____ (April 30, 1996). Law Enforcement News.
              </p>

              <p>
                _____ (August 18, 2003). Study: 7 in 37 U.S. Adults Have "prison experience". The Associated Press.
              </p>

              <p>
                _____ (August 18, 2003). The Associated Press.
              </p>

              <p>
                _____ (September 30, 1996). U.S. News & World Report.
              </p>
                ...
                <p>
                  <em>
                    Copyright Correctional Education Association Sep 2004
    Harvey Shrum, Ed .D., is a Re-Entry teacher at Folsum State Prison. At the urging of the late Dr. Fabry, Institute of Logotherapy, Dr. Shrum is nearing completion of a self-help book entitled seeking Meaning in a Cell.<br>
