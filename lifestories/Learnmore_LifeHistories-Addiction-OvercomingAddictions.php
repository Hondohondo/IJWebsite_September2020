...
<?php include "../phone-nav2.php";?>
        <div class="expand">
                ...
                <section class="section-inside">
                  <div class="section-inside-header sticky">
                    ...
                    <div class="inside-nav-container">
                      <hr class="work-hr">
                    <ul class="inside-nav">
                      <li><a href="../Specialized_Health_AddRecovery-Articles.php">&larr; Addiction Recovery</a></li>
                  ...
                  <div class="banner">
                    <div class="banner-img" id="banner-img-55">&nbsp;</div>
                  </div>

                <div id="my-content" class="section-inside-content cms-editable">
                  <h1>Overcoming Addictions: The <em>Intensive Journal</em>® Method and Twelve-Step Programs</h1>
                  <!-- <p class="right-span">By Vic T.</p> -->
                  <p>by Beverly A.</p>

                  <h6>Writing in Recovery</h6>
            ...
            The value of writing in recovery from alcohol and other addictions has long been noted in treatment and twelve-step circles. The twelve steps, which are the recovery tools of Alcoholics Anonymous ("AA") and other programs patterned after it, include two written inventory steps, and there are many twelve-step guidebooklets available, designed to promote inner awareness in the recovering person through a question and answer format. In addition, many twelve-step sponsors recommend that their "pigeons" (the AA term for sponsee) keep a journal as their recovery journey progresses. When used under the tutelage of an available sponsor, counselor, or spiritual guide, these writings can provide the newly recovering person with an excellent recovery tool.
                ...
                <p>
                However, as the recovering person becomes more autonomous, just how effective is writing, and specifically journal writing, as a recovery tool? Dr. Ira Progoff has written about the decreasing effectiveness of unguided journal writing over time (At A Journal Workshop, p. 28). Whereas unguided journal writing often declines into behavior analysis and circuitous thinking, says Dr. Progoff, the <em>Intensive Journal</em> process does not. Instead, through its non-judgmental, non-analytic nature, the <em>Intensive Journal</em> method, created by Progoff in the 1950s and 1960s and based upon the principles of holistic depth psychology, gives the writer a mirroring capability that increases the power and effectiveness of the process over time. This experience of seeing oneself through one's own uncensored words, without the burden of judgment or analysis, has an empowering effect upon the user.
                </p>
        ...
        In AA, the recovering person experiences this principle of non-judgmental self-awareness through the mirror of admitting powerlessness in the first step. When the burden of analyzing the whys and wherefores is lifted, the opportunity exists to see one's situation more clearly. On that basis, the recovering person begins to move naturally in the direction of change.
            ...
            Yet according to the steps, that change comes from a "Power greater than ourselves." Through step two, one becomes aware of that power, and in step three, one makes a decision to let that Power guide his or her life. For some that Higher Power may be the recovery group, for others a sponsor, and for others the god of their understanding.
                ...
                <p>
            Similarly, through the <em>Intensive Journal</em> method's catalytic process, one becomes connected with that power, experienced as a power from within that is somehow wiser than one's everyday thought processing. This empowerment may appear in the form of a talent or inclination for creative writing or other previously unexpected creative behavior.
                </p>

                <p>
    In the <em>Intensive Journal</em> method, as in the Twelve-Step program, one's understanding of which doctrine or belief system, if any, to attach to that power, is a personal decision. The experience, however, of combining these two powerful recovery tools, the twelve steps and the <em>Intensive Journal</em> method, is synergistic.
                </p>
...
<h6>
  My Personal Journey
                ...
                <p>
              I have been using the <em>Intensive Journal</em> method for many years. As images of my life began to cover the pages of my <em>Intensive Journal</em> workbook, I began to feel more at ease with my life as it was unfolding. The quiet atmosphere of writing and reflecting with other inwardly focused individuals in a group setting has a renewing effect upon me. Since that first workshop, I have attended several <em>Intensive Journal</em> workshops, and each one has offered me valuable perspectives in my recovery journey.
                </p>

                <p>
              My <em>Intensive Journal</em> workbook has been my friend and confidant through many life passages and transitions. It has accompanied me to Alanon and to Overeaters Anonymous ("OA") meetings, many of which have given me additional information about myself to add to my use of the <em>Intensive Journal</em> method.
                </p>

                <p>
As for my Twelve-Step journey, I attended my first OA meeting in 1978, and weaved in and out of the program for several years as I struggled to figure out if I was indeed "powerless over food." One of the most powerful experiences I had in finally making this commitment to work on the twelve steps and my food compulsion came during an <em>Intensive Journal</em> workshop when we did the "Dialogue with Body" exercise in our workbooks. I came out of that experience both amused and deflated after dialoguing with my body by its powerful response concerning my abuse of it. After the workshop, I continued these conversations and gradually became able to look into the mirror of my writing and see the next logical step, which was to work the twelve steps.
                </p>

                <p>
    The dialogues with my body were only part of the puzzle that the work revealed to me. The Journal FeedbackTM process utilized the structure of previous exercises as it helped me look back on what I had written to work with it in new sections. Using this mirroring process, I was able to see the inner pain playing itself out in my life and relationships. I felt an inner core of strength that would carry me through whatever I needed to go through to heal. The <em>Intensive Journal</em> method was a major factor in my returning to twelve-step work with a commitment that had previously been absent. The mirror and push from within that it somehow created in my life were instrumental in my readiness to begin the recovery process anew.
                </p>

                <p>
      Once I made that decision to begin working my Twelve-Step program in earnest, I realized that I needed to connect with my Higher Power, to whom I refer as God. I was able to do this by turning to my <em>Intensive Journal</em> workbook. I spent a summer doing exercises in a section in which I dialogued with my inner wisdom figure, who was in my case my Higher Power. It was in this section that I looked to my inner wisdom figure for guidance and ultimate knowledge. I would preface each writing session with a prayer to be guided to do His will and would then sit in quiet meditation for ten minutes or so before beginning to write. I found this section very helpful in keeping me God-centered, rather than self-centered during the day.
                </p>
                ...
                <p>
                  Today I can say that Alanon and the <em>Intensive Journal</em> method have been my constant companions in keeping track of myself and what is best for me in the middle of the many ups and downs that work with addicts can bring. Through this inner work, I have met and become consciously connected with a strong core within myself. This inner calm, coupled with increased creativity in all areas of my life, has emerged naturally over the years, and continues to grow as I grow in my <em>Intensive Journal</em> method and twelve-step recovery process.

                </p>

                <p>
                  As with any skill, using the <em>Intensive Journal</em> method takes practice, especially when being balanced with the twelve-step program. For a while, I used my <em>Intensive Journal</em> workbook as a daily personal inventory stop. I would diligently record my character defects in the daily log section and then leave them there to gather power with each rereading. What resulted was an impasse in both my Twelve-Step and my <em>Intensive Journal</em> work.
                </p>

                <p>
                  I came to realize that I had eliminated the most important part of the method: its unique Journal Feedback process. The <em>Intensive Journal</em> method is not simply taking an inventory of oneself or a daily log of occurrences (emotions as well as events). It involves going back and forth between the sections of the workbook that helped me to realize connections and relationships between different areas of one's life.
                </p>

                <p>
                  Even though I no longer use the <em>Intensive Journal</em> method merely for the inventory work, it has taken the sting out of inventorying for it has helped me to see my life as an unfolding process instead of as a series of wrongs and rights along the way. For Twelve Steppers, the slogan "Utilize, don't analyze," reminds one to use one's life experiences as lessons for growth rather than for self-bashing, and which goes to the core of the <em>Intensive Journal</em> method.
                </p>

                <p>One story told, told by Dr. Progoff on his tape, "Non-Analytic Ways to Growth," was of the greatest help to me for weathering the storms of life's ups and downs. He tells of a monk who suddenly found himself unable to complete even the most mundane of tasks without error. Since the monk's work was to maintain the monastery, these small mistakes were to him disasters. Nothing seemed to help, so the monk decided to go into solitude in the woods, to spare his fellow monks his incompetence, which for all he knew would be permanent.</p>
                ...
                <p>
                  When I closed my eyes later that night to go to sleep, the limb reappeared in my mind's eye. I was still standing on it. But under the limb this time I saw steel supports holding it up, and there I was standing firmly on the limb, looking out over the terrain of life fearlessly. This image reminded me that today my inner life is much stronger than it was in the past and that I am indeed capable of handling a wide variety of activity. The self-pity dissipated. Increased feelings of inner strength, serenity, and gratitude replaced it and I drifted into a peaceful nights sleep. Another rock dropped through use of the <em>Intensive Journal</em> method.
                </p>

                <p>
                  Now, after nine years of using the <em>Intensive Journal</em> method, I have been able to sort out the conflicts of recovering from addictions of my own and from the effects of others' addictions. I believe that the method has, does, and will continue to work as a tool for accessing my inner capacities and wisdom and for spiritual development. As we say in the twelve-step programs, "It works if you work it."
                </p>
