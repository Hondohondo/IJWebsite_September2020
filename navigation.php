...
<div class="col-0-of-3" id="side-navigation">
  <!-- <h1 class="heading-primary">
      <span class="heading-primary--main">Progoff <span class="emphasize"><em>Intensive Journal</em></span> <sup>&reg;</sup> Program  </span>
          ...
          <a href="index.php" class="header1-href">
            ...
            <div class="header1__text-box">
                <h1 class="heading-primary1">
                    <span class="heading-primary1--main">Progoff <em>Intensive Journal</em> <sup>&reg;</sup> Program  </span>
                    <span class="heading-primary1--sub">for Self-Development</span>
                </h1>
            </div>
<!--
            <div class="header__text-box">
                <h1 class="heading-primary">
                    <span class="heading-primary--main">Progoff <em>Intensive Journal</em> <sup>&reg;</sup> Program  </span>
                    <span class="heading-primary--sub">For Self-Development</span>
                </h1>
            </div>
                ...
                <ul class="navigation__list">
                  <li class="navigation__item">
                      ...
                      <ul class="navigation__item--nested">
                          ...
                          <li><a href="Intensive_quick-summary.php#quick" id="quick">Quick Summary</a></li>
                          <!-- <li class="highlight"><a href="Intensive_online-workshop.php#online" id="online">Online Workshop</a></li> -->
                          <li><a class="highlight" href="Intensive_online-workshop.php#online" id="online">Online Workshops</a></li>
                    ...
                    <li class="navigation__item">
                        ...
                        <ul class="navigation__item--nested">
                            ...
                            <li><a href="AboutMethod_IntensiveWorkbook.php#workbook" id="workbook"><em>Intensive Journal</em> Workbook</a></li>
                            <li><a href="AboutMethod_JournalFeedback.php#feedback" id="feedback">Journal Feedback Process</a></li>
                            ...
                            <li><a href="AboutMethod_Meditation.php#meditate" id="meditate">Entrance Meditation</a></li>
                        ...
                        <ul class="navigation__item--nested">
                            ...
                            <li>
                              ...
                              <ul class="navigation__item--nested--nested">
                                ...
                                <li class="nested-list"><a href="Specialized_Spirituality_Testimonials-Overview.php#sptest" id="sptest">Testimonials by Religion</a></li>
